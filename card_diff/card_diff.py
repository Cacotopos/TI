...
REPORT_CSS = """
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .export-btn { background: #3b82f6; color: white; border: none; padding: 0.6rem 1.2rem; border-radius: 0.5rem; cursor: pointer; font-size: 0.9rem; font-weight: 600; transition: background 0.15s; }
  .export-btn:hover { background: #2563eb; }
  main { max-width: 1100px; margin: 2rem auto; padding: 0 1.5rem; }
  .folder-section { margin-bottom: 1.25rem; }
  .folder-header { display: flex; align-items: center; gap: 0.75rem; padding: 0.85rem 1.25rem; background: #12151f; border: 1px solid #2d3148; border-radius: 0.75rem; cursor: pointer; user-select: none; }
  ...
  .card { background: #1a1d27; border: 1px solid #2d3148; border-radius: 0.75rem; margin-bottom: 0.6rem; overflow: hidden; }
